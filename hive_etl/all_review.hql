...
create table movie.all_review(product_id string, user_id string, profile_name string, helpfulness string, score decimal(2,1), time timestamp, summary string, text string);

insert into table movie.all_review select * from movie.all_review_t;
